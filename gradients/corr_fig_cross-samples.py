...
for idx_threshold, threshold in enumerate(thresholds):
    ...
    # Illustrate results
    fig, ax = plot_methods_grid(r_all_methods,r_surr_all_methods,p_all_methods,approaches=approaches,kernels=kernels,thresholds=sc_sample_names)
    fig.savefig(PROJ_DIR+'gradients/figures/corr_grid_samples_threshold_'+str(threshold)+'_mean_FC_'+str(n_surr)+'_surrogates.png',bbox_inches="tight")
...
for idx_threshold, threshold in enumerate(thresholds):
    ...
    # Illustrate results
    fig, ax = plot_methods_grid(r_all_methods,r_surr_all_methods,p_all_methods,approaches=approaches,kernels=kernels,thresholds=[str(thresh) for thresh in sc_sample_names])
    fig.savefig(PROJ_DIR+'gradients/figures/corr_grid_samples_threshold_'+str(threshold)+'_mean_grads_'+str(n_surr)+'_surrogates.png',bbox_inches="tight")
